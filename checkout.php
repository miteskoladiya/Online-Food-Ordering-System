...
if (empty($_SESSION["user_id"])) {
    ...
    foreach ($_SESSION["cart_item"] as $item) {
       ...
       // $item_total_GST = ($item_total* 0.18)+$item_total;
      }
    ?>
            ...
            <header id="header" class="header-scroll top-header headrom">
                <nav class="navbar navbar-dark">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food-mohalla.png"
                                alt="" width="70px" height="50px"> </a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-color"><strong>
                                                                        <?php echo "₹" . round($item_total); ?></strong></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-20">
                                                            <input name="mod" id="radioStacked1" checked value="COD"
                                                                ...
                                                                class="custom-control-description">Cash on Counter</span>
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-10">
                                                            <input name="mod" type="radio" value="paypal"
                                                                ...
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description">UPI <img
